...
<body>
	<div class="panel">
		<div class="panel-heading text-center">
			<span class="panel-title"><h1>Page Under Construction</h1></span>
		</div>
		<div class="panel-body text-center">
			<img src="<?= base_url() ?>public/assets/img/undercon.png" alt="" class="img-fluid m-5" style="width: 200px;">
		    <h5 class="card-title">The page is still under development, it is coming soon.</h5>
