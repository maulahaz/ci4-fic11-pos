...
<nav class="navbar navbar-expand-lg main-navbar">
            ...
            <div class="search-result">
                ...
                <div class="search-item">
                    <a href="#">
                        <img class="mr-3 rounded"
                            width="30"
                            src="<?=base_url()?>t_stisla/img/products/product-3-50.png"
                            alt="product">
                ...
                <div class="search-item">
                    <a href="#">
                        <img class="mr-3 rounded"
                            width="30"
                            src="<?=base_url()?>t_stisla/img/products/product-2-50.png"
                            alt="product">
                        Drone X2 New Gen-7
                    </a>
                </div>
                <div class="search-item">
                    <a href="#">
                        <img class="mr-3 rounded"
                            width="30"
                            src="<?=base_url()?>t_stisla/img/products/product-1-50.png"
                            alt="product">
                        Headphone Blitz
                    </a>
                </div>
    ...
    <ul class="navbar-nav navbar-right">
        <li class="dropdown"><a href="#"
                ...
                <img alt="image"
                    src="<?=base_url()?>t_stisla/img/avatar/avatar-1.png"
