...
$routes->get('/dashboard', 'PageController::dashboard', ['filter'=>'mhzfilter:auth']);
$routes->get('/forbidden', 'PageController::forbidden');
$routes->get('/undercon', 'PageController::undercon');
